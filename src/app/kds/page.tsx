...
import { CheckCircle2, Flame, ChefHat, Clock, AlertTriangle, ArrowRight, Snowflake, Beer, ThermometerSun, Volume2, VolumeX, Zap, LayoutGrid, List, Sparkles, Activity, Search, Filter, Sun, Moon, Bell, Utensils, ChevronDown, Table as TableIcon, MessageSquare, Book as BookIcon } from "lucide-react";
                ...
                <div className="w-full overflow-x-auto md:overflow-visible no-scrollbar py-6 px-4 md:px-8">
                    <div className="min-w-max mx-auto flex items-center justify-center">
                        <motion.div
                            ...
                            className="relative z-50 flex items-center gap-1.5 bg-white/80 dark:bg-black/80 backdrop-blur-2xl border border-white/20 dark:border-white/10 rounded-full p-2 shadow-2xl ring-1 ring-black/5 dark:ring-white/5"
                        >

                            {/* 1. Station Filters Group */}
                            {/* 1. Station Filters Group (Motion Design) */}
                            <div className="flex items-center p-1.5 bg-neutral-100/50 dark:bg-neutral-900/50 rounded-full border border-black/5 dark:border-white/5 shadow-inner relative group/filters">
                            ...
                            <div className="flex items-center gap-3 px-6 h-12 rounded-full bg-neutral-100/50 dark:bg-neutral-900/50 border border-black/5 dark:border-white/5">
                                ...
                                <div className="flex items-center gap-2.5">
                                    <span className="text-[12px] font-black text-accent-gold nums-proportional">
                                        {preparingOrders.length}<span className="text-neutral-300 dark:text-neutral-700 mx-1">/</span>{orders.length}
                                    </span>
                                ...
                                <AnimatePresence mode="wait">
                                    {isSearchExpanded ? (
                                        ...
                                        >
                                            <div className="relative mx-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full h-12 bg-neutral-100 dark:bg-neutral-900 border border-transparent focus:border-accent-gold/50 rounded-full pl-10 pr-4 text-[11px] font-bold uppercase tracking-wider focus:outline-none focus:ring-4 focus:ring-accent-gold/10 transition-all placeholder:text-neutral-400"
                                                />
                                            </div>
                                        </motion.div>
                                    ) : (
                                        <motion.button
                                            ...
                                            className="w-12 h-12 flex items-center justify-center rounded-full text-neutral-400 hover:text-accent-gold hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors"
                                        >
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        isGridDropdownOpen
                                            ...
                                            : "bg-transparent border-transparent hover:bg-neutral-100 dark:hover:bg-neutral-900 text-neutral-600 dark:text-neutral-300"
                                    )}
                                >
                                ...
                                <AnimatePresence>
                                    {isGridDropdownOpen && (
                                        <motion.div
                                            ...
                                            className="absolute top-full left-1/2 -translate-x-1/2 mt-2 p-1.5 w-16 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-xl flex flex-col gap-1 items-center overflow-hidden z-[101]"
                                        >
                                            {[3, 4, 5, 6].map(num => (
                                                <button
                                                    key={num}
                            ...
                            <div className="w-px h-10 bg-neutral-200 dark:bg-neutral-800 mx-4" />
                            ...
                            <div className="flex items-center gap-4 pr-1 relative z-10">
                                ...
                                <div className="flex flex-col items-center min-w-[80px]">
                                    ...
                                    <span className="font-variant-numeric text-xl font-medium tracking-tight text-neutral-900 dark:text-white leading-none">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        rushMode
                                            ...
                                            : "bg-white dark:bg-black border-neutral-200 dark:border-neutral-800 text-neutral-400 hover:text-accent-gold hover:border-accent-gold/50"
                                    )}
                                >
                                ...
                                <div className="relative pl-2 pr-1">
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            pendingModificationsCount > 0
                                                ? "bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 ring-2 ring-amber-500/20"
                                    ...
                                    >
                                        ...
                                        {pendingModificationsCount > 0 && (
                                            <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-white text-[9px] font-black rounded-full flex items-center justify-center border-2 border-white dark:border-black shadow-sm transform group-hover:scale-110 transition-transform">
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={cn(
                                            ...
                                            isReady
                                                ? "border-neutral-200 dark:border-neutral-700 bg-neutral-50/50 dark:bg-neutral-900/50 grayscale-[0.5]"
                                                : isUrgent
                                                    ...
                                                    : isWarning
                                                        ...
                                                        : "border border-black dark:border-border shadow-2xl shadow-neutral-200/50 dark:shadow-none hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] hover:border-accent-gold/40"
                                        )}
                                    >
                                        <div className={cn(
                                            "flex flex-col gap-3 p-5 md:p-6 border-b transition-all duration-700 relative overflow-hidden",
                                            isReady ? "bg-neutral-100/50 dark:bg-neutral-800/50 border-neutral-200 dark:border-neutral-700" :
                                                isUrgent ? "bg-error-soft/30 border-error/10" :
                                                    isWarning ? "bg-warning-soft/30 border-warning/10" :
                                                        "bg-neutral-50 dark:bg-bg-tertiary/30 border-border/50"
                                        )}>
                                            ...
                                            <div className="relative z-10 flex flex-col gap-3">
                                                ...
                                                <div className="flex items-center justify-between w-full min-h-[40px]">
                                                    <div className="flex items-center gap-2 min-w-0">
                                                        <h3 className={cn(
                                                            "font-serif font-medium tracking-tight italic text-black dark:text-white leading-none truncate drop-shadow-sm translate-y-0.5",
                                                ...
                                                <div className="flex items-center justify-between w-full gap-2 h-8">
                                                    ...
                                                    <div className={cn(
                                                        ...
                                                        isUrgent || (rushMode && elapsedMinutes > 5)
                                                            ...
                                                            : isWarning
                                                                ...
                                                                : "bg-white dark:bg-bg-secondary text-black dark:text-white border-neutral-200 dark:border-border"
                                                    )}>
                                                    ...
                                                    <div className="flex items-center gap-3 min-w-0 justify-end h-full">
                                                        <span className="text-[10px] font-black uppercase tracking-[0.15em] text-neutral-600 dark:text-neutral-400 truncate text-right leading-none pt-0.5">
                                                            {ticket.serverName}
                                                        </span>
                                                        <div className="w-8 h-8 rounded-full bg-white dark:bg-bg-tertiary flex items-center justify-center border border-neutral-200 dark:border-border shrink-0 shadow-sm">
                                                            <ChefHat className="w-4 h-4 text-neutral-700 dark:text-neutral-300" strokeWidth={2} />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {ticket.items.flatMap(item => {
                                                ...
                                                return (
                                                    <div key={i} className={cn(
                                                        "group relative bg-white dark:bg-bg-primary rounded-[20px] overflow-hidden border shadow-sm hover:shadow-md transition-all duration-500",
                                                        hasMods
                                                            ? "border-amber-500 dark:border-amber-500 ring-2 ring-amber-500/50 shadow-[0_0_20px_rgba(245,158,11,0.3)] animate-pulse-slow"
                                                        ...
                                                        <div className="p-4 relative">
                                                            <div className="flex justify-between items-start gap-2 mb-2">
                                                                <h4 className="font-serif text-lg font-bold text-black dark:text-white leading-tight">
                                                                    {item.name}
                                                                </h4>
                                                            </div>
                                                            ...
                                                            {item.modifiers && item.modifiers.length > 0 ? (
                                                                <div className="flex flex-col gap-1.5 mt-2">
                                                                    {item.modifiers.map((m, mi) => (
                                                                        <span key={mi} className="text-xs font-bold text-amber-600 dark:text-amber-400 flex items-start gap-2">
                                                            ...
                                                            {item.notes && (
                                                                <div className="mt-3 p-2.5 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 text-amber-900 dark:text-amber-400 text-xs font-bold leading-tight flex items-start gap-2 animate-pulse">
                                                                    <MessageSquare className="w-3.5 h-3.5 shrink-0 mt-0.5 opacity-70" />
                                                                    <span>"{item.notes}"</span>
                                                                </div>
                                                            )}

                                                            <div className="mt-4 pt-3 border-t border-dashed border-neutral-200 dark:border-neutral-800 flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-neutral-500 dark:text-neutral-500">
                                            ...
                                            <AnimatePresence mode="wait">
                                                {ticket.status === "ready" ? (
                                                    <motion.button
                                                        ...
                                                        animate={{ opacity: 1, y: 0 }}
                                                        className="w-full h-16 rounded-[20px] font-black uppercase tracking-[0.3em] text-[11px] transition-all border border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-700/80 hover:border-neutral-300 flex items-center justify-center gap-4 active:scale-[0.98] shadow-sm group"
                                                    ...
                                                    <motion.div key="progress" className="flex gap-4">
                                                        {ticket.status === "new" ? (
                                                            <button
                                                                className="w-full h-16 rounded-[20px] font-black uppercase tracking-[0.3em] text-[11px] transition-all bg-neutral-100 dark:bg-bg-tertiary text-gray-900 dark:text-text-primary hover:bg-neutral-200 dark:hover:bg-bg-tertiary/80 active:scale-[0.98] shadow-premium flex items-center justify-center gap-3"
                                                                onClick={() => updateOrderStatus(ticket.id, 'preparing')}
                                                            >
                                                                <Flame className="w-5 h-5 text-orange-500 dark:text-accent-gold" strokeWidth={2.5} />
                                                                LANCER
                                                            </button>
                                                        ) : (
                                                            <button
                                                                className="w-full h-16 rounded-[20px] font-black uppercase tracking-[0.3em] text-[11px] transition-all bg-emerald-500 dark:bg-success text-white hover:bg-emerald-600 dark:hover:bg-success/90 active:scale-[0.98] shadow-xl shadow-emerald-500/20 dark:shadow-success/10 flex items-center justify-center gap-3"
